...
const WrapperVP = () => {
  return (
    <div className="flex flex-col p-3 lg:flex-row lg:gap-5 items-center justify-center gap-4">
      ...
      <div className="bg-[#1F1F1F] rounded-2xl flex items-center shadow-wlrd justify-center mt-[-8%] mr-0 p-2 lg:mr-[6%] font-poppins text-xl w-[98%]  md:w-[85%] md:p-4 lg:w-[450px] lg:h-[420px] lg:p-7 
      lg:scale-[1.15] ">
        <Payment  />
      </div>
    </div>
