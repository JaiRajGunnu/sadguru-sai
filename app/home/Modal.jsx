  ...
  return (
    <div className="relative mt-[-5%] md:mt-0 lg:mt-0">
      <Dialog open={isOpen} onOpenChange={setIsOpen} className="">
        ...
        <DialogContent className="text-base lg:max-w-[1000px] bg-[#0f1014] rounded-xl text-white border-none p-8 w-[95%] h-[43%] md:w-[75%] md:h-[50%] md:items-center lg:justify-center lg:items-center lg:w-[100%] lg:h-[80%]">
        ...
        className="h-[260px] w-[100%] mt-[-5%] md:mt-[-10%] lg:mt-0 md:h-[380px] lg:w-[825px] lg:h-[500px] lg:p-05"
        allowFullScreen
        allow="fullscreen"
      ></iframe>
