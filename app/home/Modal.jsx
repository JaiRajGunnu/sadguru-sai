  ...
  return (
    <div className="relative mt-[-5%] md:mt-0 lg:mt-0">
      <Dialog open={isOpen} onOpenChange={setIsOpen} className="">
        ...
        <DialogContent className="text-base lg:max-w-[1000px] bg-[#0f1014] rounded-xl text-white border-none p-8 w-[95%] h-[42%] md:w-[75%] md:h-[65%] md:items-center lg:justify-center lg:items-center lg:w-[100%] lg:h-[80%]">
